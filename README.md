...
Don't want to build from source? Get the signed installer, lifetime updates and setup support for a one-time payment at [onetimesuite.com/billcraft](https://onetimesuite.com/billcraft/) — same app, MIT source right here.
